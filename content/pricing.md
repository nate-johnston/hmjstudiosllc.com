...
I charge $90 a month per student. This entitles each student to a set number of
lessons based on the starting month and ending August 31, 2019. I will keep
...
have 2 lessons. The cost each month will always be $90 with the possible
exception of the summer months (see Summer Lessons below).

<table border=0 cellpadding=2 cellspacing=1>
<tr>
<td><b>Starting<br>Month</b></td>
<td><b>Number of<br> Lessons</b></td>
</tr><tr>
<td>September</td><td>40</td>
</tr><tr>
...
Students beginning in May, June, or July will be exempt from the subscription policy and will instead be charged $27 per lesson until the new term begins. No new students will begin in August.</td></table>
...
Parents are also responsible for reimbursing any new book/music fees. New book
...
taken will be totaled and multiplied by $27 per lesson, then compared against
...
* 16 lessons x $27 per lesson = $432
* 4 months x $90 per month = $360
* The parent still owes $72.

Example: Johnny stops taking lessons after 7 months having taken 22 lessons.

* 22 lessons x $27 per lesson = $594
* 7 months x $90 per month =$630
* The parent receives a $36 refund.
<br>
<br>
<br>
