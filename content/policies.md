...
Please have your child use the practice log in My Music Staff. A login has been provided to each family. A new login can be sent if necessary. Your password and username are never shared with anyone other than you. Using the practice log helps with lesson planning and is a great way for the students to communicate between lessons. This is a wonderful tool, please help your student access it!
